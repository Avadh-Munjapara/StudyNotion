...
export const adminEndpoint = {
  CREATE_CATEGORY_API: `${baseUrl}/admin/createCategory`,
  GET_STATS_API: `${baseUrl}/admin/stats`,
  GET_TOP_INSTRUCTORS_API: `${baseUrl}/admin/topInstructors`,
  GET_MOST_SELLING_COURSES_API: `${baseUrl}/admin/mostSellingCourses`,
  GET_CATEGORYWISE_STUDENTS_API: `${baseUrl}/admin/categorywiseStudents`,
};
