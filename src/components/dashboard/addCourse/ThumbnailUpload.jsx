...
const ThumbnailUpload = ({ register, erros, watch }) => {
  ...
  return (
    <>
      {filePreview ? (
        <div className="flex items-end gap-3 border-dashed border-[1.5px] rounded-lg border-[#424854] py-4 px-3 bg-[#2C333F]">
          <img className="h-60 w-fit rounded-lg" src={filePreview} alt="" />
