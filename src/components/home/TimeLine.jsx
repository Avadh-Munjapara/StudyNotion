        ...
        <div className='w-11/12 flex justify-center gap-20 items-center mx-auto  pb-14'>
            <div className='flex flex-col w-[45%] h-fit'>
            {
               data.map((item,index)=>{
                return(
                    <div>
      <div className="flex flex-row gap-8 items-center text-richblack-700" key={index}>
                        <div className=''>
                    ...
                    {
                        index<3?<div className='relative left-8 flex flex-col gap-1'>
            ...
            <div className='h-fit object-cover relative'>
                ...
                <img src={timeLineImage} className='border-r-[15px] border-b-[15px]  border-white' alt="" />
                </div>
                <div className='absolute h-full w-[calc(100%+10px)] top-[1%] left-[-1%] opacity-60 blur-lg rounded-full bg-gradient-to-r from-[#9CECFB] via-[#65C7F7] to-[#0052D4]'>
